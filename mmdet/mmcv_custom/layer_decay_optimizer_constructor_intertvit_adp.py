...
def get_num_layer_for_vit(var_name, num_max_layer):
    if var_name =='backbone.level_embed':
        return 0
    elif var_name.startswith('backbone.embeddings.position_embedding') or \
            var_name.startswith('backbone.embeddings.patch_embedding'):
        return 0
...
class InternViTAdapterLayerDecayOptimizerConstructor(DefaultOptimWrapperConstructor):
