...
def parse_args():
    ...
    parser.add_argument(
        'inputs', type=str, default="/data/lzm/mmdection/mmdetection-main/demo/demo.jpg", help='Input image file or folder path.')
    parser.add_argument(
        'model', 
        type=str,
        default="/data/lzm/mmdection/mmdetection-main/rtmdet_tiny_8xb32-300e_coco.py",
        help='Config or checkpoint .pth file or the model name '
        'and alias defined in metafile. The model configuration '
        'file will try to read from .pth if the parameter is '
        'a .pth weights file.')
    parser.add_argument('--weights', default="/data/lzm/mmdection/mmdetection-main/rtmdet_tiny_8xb32-300e_coco_20220902_112414-78e30dcc.pth", help='Checkpoint file')
    parser.add_argument(
        '--out-dir',
        type=str,
        default='outputs',
